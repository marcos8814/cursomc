...
public class Cliente implements Serializable{
	...
	public Cliente(Integer id, String nome, String email, String cpfOuCnpj, TipoCliente tipo) {
		...
		this.tipo = tipo.getCod();//Acrescentar o codigo .getCod()
	}
	...
	public TipoCliente getTipo() {
		return TipoCliente.toEnun(tipo);//Enumeração troca o codigo Get por este 
	}

	public void setTipo(TipoCliente tipo) {//Acrescentar o codigo .getCod()
